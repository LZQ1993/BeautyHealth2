...
public class CWChartView extends ChartView {

	public CWChartView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}
	
	 public CWChartView(Context context, AttributeSet attrs){   
	        super(context, attrs);   
	        
	 }
	 
	 public CWChartView(Context context, AttributeSet attrs, int defStyle) {
