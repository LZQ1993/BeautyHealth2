 ...
 */
public class ActionMonitorActivity extends DataRequestActivity{
    private String currentNotiName = "ActionMonitorDataNotifications";
    ...
    private void showDialog(){
        ...
        startTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(ActionMonitorActivity.this,
        ...
        endTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Calendar c = Calendar.getInstance();
                new DatePickerDialog(ActionMonitorActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        int month = (monthOfYear + 1);
                        String strdate = year + "-";
        ...
        //对话框
        new AlertDialog.Builder(ActionMonitorActivity.this)
                .setView(itemview)
                .setTitle("提示：输入条件")
                .setPositiveButton("确定", new Dialog.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (startTime.getText().toString().equals("")||endTime.getText().toString().equals("")) {
                            ToastUtil.show(ActionMonitorActivity.this, "查询信息不能为空");
