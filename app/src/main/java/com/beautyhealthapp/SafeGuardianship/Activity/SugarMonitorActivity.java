...
import com.Entity.BloodSugarInfo;
 ...
 */
public class SugarMonitorActivity extends DataRequestActivity{
    private String currentNotiName = "SugarMonitorDataNotifications";
    private SplineChartView mspchar;
    private List<BloodSugarInfo> testDataPressure= new ArrayList<BloodSugarInfo>();
    ...
    private void set2DLines() {
        if (testDataPressure.size() > 0) {
            ...
            for (int i = 0; i < testDataPressure.size(); i++) {
                BloodSugarInfo ap = testDataPressure.get(i);
    ...
    private void setTimeSelected(FrameLayout content) {
        ...
        View convertView = inflater.inflate(R.layout.activity_bloodsugar_navbar, null);
    ...
    private void InitData() {
        ISqlHelper isqlHelper = new SqliteHelper(null, SugarMonitorActivity.this);
    ...
    public void updateView(){
        if (result != null) {
            dataResult = dataDecode.decode(result, "BloodSugarInfo");
            if (dataResult != null) {
                ...
                if (CurrentAction == currentNotiName) {
                    if (realData.getResultcode().equals("1")) {
                        ...
                        for (int i = 0; i < realData.getResult().size(); i++) {
                            BloodSugarInfo msg = (BloodSugarInfo) realData.getResult().get(i);
    ...
    private void showDialog(){
        ...
        startTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(SugarMonitorActivity.this,
        ...
        endTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Calendar c = Calendar.getInstance();
                new DatePickerDialog(SugarMonitorActivity.this, new DatePickerDialog.OnDateSetListener() {
                            @Override
                            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                                int month = (monthOfYear + 1);
                                String strdate = year + "-";
        ...
        //对话框
        new AlertDialog.Builder(SugarMonitorActivity.this)
                .setView(itemview)
                .setTitle("提示：输入条件")
                .setPositiveButton("确定", new Dialog.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (startTime.getText().toString().equals("")||endTime.getText().toString().equals("")) {
                            ToastUtil.show(SugarMonitorActivity.this, "查询信息不能为空");
