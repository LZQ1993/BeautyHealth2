 ...
 */
public class SugarDataShowActivity extends DataRequestActivity{
    private String currentNotiName = "MySugarDataNotifications";
    ...
    private void showDialog(){
        ...
        startTimeEd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(SugarDataShowActivity.this,
        ...
        // 对话框
        new AlertDialog.Builder(SugarDataShowActivity.this).setView(itemview)
                .setTitle("提示：输入条件")
